    ...
    public class PlatformerMotor2D : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            if (_rigidbody2D != null)
            {
                ...
                _originalKinematic = _rigidbody2D.bodyType == RigidbodyType2D.Kinematic;
        ...
        private void OnDisable()
        {
            if (_rigidbody2D != null)
            {
                ...
                _rigidbody2D.bodyType = _originalKinematic ? RigidbodyType2D.Kinematic : RigidbodyType2D.Static;
                #else
